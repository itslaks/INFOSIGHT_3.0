...
logger.info("=" * 70)
logger.info("🔐 InfoCrypt - Initializing")
logger.info("=" * 70)
...
@validate_request({
    "text": {
        "type": "string",
        "required": True,
        "max_length": 5000000  # 5MB in characters (approximate)
    },
    "algorithm": {
        "type": "string",
        "required": False,
        "max_length": 50,
        "allowed_values": HASH_ALGORITHMS
    },
    "iterations": {
        "type": "int",
        "required": False,
...
def hash_endpoint():
    ...
    try:
        ...
        text = InputValidator.validate_string(
            data.get('text'), 'text', max_length=5000000, required=True
        )
...
@validate_request({
    "algorithm": {
        ...
        "required": False,
        "max_length": 50,
        "allowed_values": ENCRYPTION_ALGORITHMS
    },
    "key_size": {
        "type": "int",
        "required": False,
...
if __name__ == "__main__":
    ...
    print(f'Starting infocrypt standalone mode on {host}:{port}...')
